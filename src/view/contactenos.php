          ...
          <div class="contact-form">
            ...
            <form method="post" action="" name="contact_form" id="contact_form">
              <div class="row">
                ...
                <div class="col-md-6">
                  <input type="text" name="cnt_telefono" id="cnt_telefono" placeholder="Numero de Telefono">
                </div>
                <div class="col-md-6">
                  <input  type="email" name="cnt_email" id="cnt_email" placeholder="Correco Electronico">
                </div>
                <div class="col-md-6">
                  <select class="form-control" name="cnt_tipodocumento" id="cnt_tipodocumento" required="required">
                     ...
                     <option value="SICOM" maxlength="6" >Codigo Sicom</option>
                   </select>
                </div>
                <div class="col-md-6">
