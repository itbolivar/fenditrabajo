...
<div class="listpgWraper">
    <div class="container">
        ...
        <div class="pageSearch">
            <div class="row">
                <div class="col-md-3"><a href="#." class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> Lista
                        de Ofertas</a></div>
                <div class="col-md-9">
        ...
        <div class="col-md-3 col-sm-6 pull-right">
            ...
            <div class="sidebar">
                ...
                <div class="social"> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square"
                            aria-hidden="true"></i></a> <a href="http://www.plus.google.com" target="_blank"><i
                            class="fa fa-google-plus-square" aria-hidden="true"></i></a> <a
                        href="http://www.facebook.com" target="_blank"> <i class="fa fa-facebook-square"
                            aria-hidden="true"></i></a> <a href="https://www.pinterest.com" target="_blank"><i
                            class="fa fa-pinterest-square" aria-hidden="true"></i></a> <a href="https://www.youtube.com"
                        target="_blank"><i class="fa fa-youtube-square" aria-hidden="true"></i></a> <a
                        ...
                        <div class="col-md-8 col-sm-8">
                            <div class="jobinfo">
                                ...
                                <div class="clearfix">Estado:
                                    <label class="seleccionado">Activa</label>
                                </div>
                            </div>
                        </div>
